        ...
        <section id="experience" className="portfolio section-bg">
          <div className="container">
            <div className="section-title">
              ...
              <p data-aos="fade-up">Bên dưới là những kinh nghiệm cá nhân của mình.</p>
            </div>
        ...
        <section id="contact" className="contact">
          <div className="container">
            ...
            <div className="row" data-aos="fade-up">
              ...
              <div className="d-none d-lg-block col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay='500'>
